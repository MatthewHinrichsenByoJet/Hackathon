/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6c034bbd2cb31dd3e33b83bd15d216fb)
// Runtime types generated with workerd@1.20250906.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		REST_URL: string;
		SABRE_AUTH_ENDPOINT: string;
		SABRE_SEARCH_ENDPOINT: string;
		GDS_PASSWORD: string;
		GDS_PCC: string;
		GDS_AGENT_CODE: string;
